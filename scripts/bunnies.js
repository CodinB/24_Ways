...
function endGame()
{
	...
	message.innerHTML += (_('<input class="button" id="shotgunButton" type="button" value="reload your shotgun!" onClick="reinitialise()">'));
	message.innerHTML += (_('<input class="button" id="stopButton" type="button" value="make the killing stop!" onClick="stop()">'));
...
function stop()
{
	...
	closing.innerHTML += _('<p class="closingMessage">The bunnies of the world thank you for your pacifism. Happy Easter!</p>');
	closing.className = _("ready");
